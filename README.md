...
1. 喺「落單」頁選產品。
2. 上方系列可以揀「美味」「健康」「幼貓」「老年7+」「小食」「玩具」「福袋」等分類。
3. 產品數量分兩邊：
   - 左邊：原箱
   - 右邊：單件
4. 長按 `+` 可以快速加數量。
5. 底部會自動計算小計、折後金額、贈品及免費送貨。
6. 按「落單」。
7. 彈窗上方會顯示收據摘要，確認產品、數量及價錢無錯。
8. 填客人姓名、電話、地址。
9. 按「確認落單」。
10. 去「訂單」頁按「確認WA」，複製文字後貼去 WhatsApp 俾客人確認。
...
- 可以標記或取消：
  ...
  - WhatsApp快遞確認
- 如要執貨，按「詳情」睇完整產品清單。
- 如客人姓名、電話或地址填錯，喺「詳情」按「編輯客人資料」修改；儲存後會同步到 Google Sheets。
